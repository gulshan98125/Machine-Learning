...
class CNN():
	def __init__(self,train_path, img_height,img_width,batch_size=50,epochs=4,learning_rate = 0.001,train_data_size=50000, fraction_train = 0.9):
		...
		model.add( layers.Conv2D(32, (3,3),strides=(2, 2),activation='relu',input_shape=(self.img_height, self.img_width,5)) )
...
m = CNN(train_path = train_data_path,train_data_size = 75000, img_height=157, img_width=160)
m.fit()

...
if __name__ == "__main__":
	...
	if part_num=='a':
		...
		test_accuracy = prediction_accuracy(test_data_path,a,b,c,pre_processing,1)*100
		print("predicting on train, "),
		train_accuracy = prediction_accuracy(train_data_path,a,b,c,pre_processing,0.2)*100
		...
		print("random test accuracy = "+ str(random_accuracy1) +" %" )
		print("random train accuracy = "+ str(random_accuracy2) +" %\n" )
		...
		print("majority test accuracy = "+ str(majority_accuracy1) +" %" )
		print("majority train accuracy = "+ str(majority_accuracy2) +" %" )
